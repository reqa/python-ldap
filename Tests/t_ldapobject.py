...
class Test01_ReconnectLDAPObject(Test00_SimpleLDAPObject):
    ...
    def test_106_reconnect_restore(self):
        ...
        print(lo.search_s(dn, ldap.SCOPE_BASE, '(objectClass=*)'))
        # this used to raise ldap.INSUFFICIENT_ACCESS, as it is became a unbound connection and does everything anonymously.
    ...
    def test_107_reconnect_restore(self):
        ...
        def reconnect_search_thread():
            ...
            except Exception as exc:  # ldap.UNAVAILABLE
                print('Exception', exc)
                excs.append(exc)
